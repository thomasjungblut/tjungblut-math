 ...
 */
public class MyNativeBlasLibraryLoader {

  public static boolean VERBOSE = false;

  public static boolean loadLibraryAndCheckErrors() {
    try {
      try {
      ...
      if (name.startsWith("Windows")
          && e.getMessage().contains("Can't find dependent libraries")) {
        if (VERBOSE) {
          System.err
              .println("On Windows, you need some additional support libraries.\n"
        ...
        if (VERBOSE) {
          System.err
              .println("On Linux 64bit, you need additional support libraries.\n"
