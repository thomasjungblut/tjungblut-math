...
public class Tuple3Test extends TestCase {
  ...
  public void testHashing() {
    ...
    // test null keys
    set = new HashSet<Tuple3<Integer, String, Double>>();
  ...
  public void testEquality() {
    Tuple3<Integer, String, Double> dv = new Tuple3<Integer, String, Double>(1,
        "lol", 9.5);
    assertEquals(false, dv.equals(null));
    assertEquals(false, dv.equals("blabla"));
    assertEquals(true, dv.equals(dv));
    assertEquals(true,
        dv.equals(new Tuple3<Integer, String, Double>(1, "lol", 9.5)));
    assertEquals(false,
        dv.equals(new Tuple3<Integer, String, Double>(2, "lol", 9.5)));

    // test nulls
    dv = new Tuple3<Integer, String, Double>(null, "lol", 2d);
    assertEquals(false, dv.equals(null));
    assertEquals(false, dv.equals("blabla"));
    assertEquals(true, dv.equals(dv));
    assertEquals(false,
        dv.equals(new Tuple3<Integer, String, Double>(1, "lol", 2d)));
    assertEquals(true,
  ...
  public void testComparable() {
    ...
    Tuple3<DoubleVector, String, Double> tx = new Tuple3<DoubleVector, String, Double>(
        null, "lol", 0.1);
    Tuple3<DoubleVector, String, Double> tx2 = new Tuple3<DoubleVector, String, Double>(
        null, "lol", 0.3);
